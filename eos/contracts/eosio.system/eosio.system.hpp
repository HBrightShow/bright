...
namespace eosiosystem {
   ...
   struct voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE( voter_info, (owner)(proxy)/*(producers)*/(vote_producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(reserved1)(reserved2)(reserved3) )
   };
   ...
   class system_contract : public native {
      ...
      private:
         ...
         void update_votes( const account_name voter,     asset quantity, const account_name proxy, const std::vector<account_name>& producers, bool voting );

...
namespace eosiosystem {
   ...
   const int64_t  	min_activated_stake   =  10'000'0000000;
   ...
   void system_contract::onblock( block_timestamp timestamp, account_name producer ) {
	   ...
	   //Begin: Removed by hml Date:2018-08-30
	   //removed update about claimrewards
#if 1
	  ...
	  print("total_activated_stake=", _gstate.total_activated_stake, "min_activated_stake=", min_activated_stake, "\n" );
...
#endif
	  //End: Removed by hml Date:2018-08-30
   }

...
//Begin: Modify by hml Date:2018-08-30
//modify interval time of produced blocks from 0.5s to 1s
const static int      block_interval_ms = 1000;
//End: Modify by hml Date:2018-08-30
...
const static uint32_t   default_max_block_cpu_usage                 = 200000; /// max block cpu usage in microseconds
...
//Begin: Modify by hml Date:2018-08-30
//modify blocksproduced number from 12 to 6
